  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-display font-bold mb-2">Find Textbooks (NGO)</h1>
          <p className="text-muted-foreground">
            Browse available books and request them for your students.
          </p>
        </div>
        ...
        {!loading && (
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
            {filteredBooks.map(book => (
              <BookCard key={book.id} book={book} linkPrefix="/ngo-books" />
            ))}
          </div>
        )}
