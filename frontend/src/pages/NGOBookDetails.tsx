  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container py-8">
        <Link to="/ngo-find-books" className="inline-flex items-center gap-2 text-sm text-muted-foreground hover:text-primary mb-6">
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-3">
              <Button
                size="lg"
                className="flex-1"
                onClick={() => navigate(`/ngo-request-book/${book.id}`)}
              >
                Request This Book
              </Button>
